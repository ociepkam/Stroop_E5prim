...
from code.load_data import read_text_from_file, load_config, check_if_font_exist
...
# check fonts
check_if_font_exist(config["small_letters_file_name_in_system"])
check_if_font_exist(config["big_letters_file_name_in_system"])
...
# prepare trials
training_trials, experiment_trials, colors_to_key, colors_names = prepare_exp(config=config, win=win, text_size=TEXT_SIZE)
